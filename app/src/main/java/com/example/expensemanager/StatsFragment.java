...
public class StatsFragment extends Fragment {
    ...
    private String[] type={"Ingresos", "Gastos"};
    ...
    public void doChartOperation(View myView){
        ...
        set1 = new LineDataSet(incomeEntries, "Ingresos");
        ...
        set2 = new LineDataSet(expenseEntries, "Gastos");
